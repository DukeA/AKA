...
/**
 * CollisionObservable interface allowing an observer to listen to board collision events.
 * @author Ken Bäcklund
 */
public interface CollisionObservable {

    /**
     * Add a new collision observer to the list, subscribing to collision events,.
