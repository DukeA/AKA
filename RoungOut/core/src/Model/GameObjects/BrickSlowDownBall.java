...
/**
 * An special brick that will slow down the ball hitting it.
 *
 * Created by DukeA on 2017-05-12.
 * Updated by Ken Bäcklund.
 */
public class BrickSlowDownBall extends Brick implements CollisionObserver {

    // Constructor ////////////////////////////////////////////////////////////

    /**
     * Creates a new Special Brick which slows down ball.
     * @param xPos the X position where to place brick.
     * @param yPos the Y position where to place brick.
     * @param width the width of the brick.
     * @param height the height of the brick.
     */
    public BrickSlowDownBall(float xPos, float yPos, float width, float height) {
        // Create the brick, assign it to be a SlowDownBall-brick.
        super(xPos, yPos, width, height);
        this.brickvalue = BrickType.SLOW_DOWN_BALL;
    }

    /**
     * Listen to when balls hits a brick. If this brick then slow down ball.
